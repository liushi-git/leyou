...
<script>
    function deleteById() {
        var id = getCheckId() //勾选的id , 勾选错误的话返回空
        if(id) {
...
<%--            <div class="box-footer">
                <form action="/company/list.do" method="get" id="pageForm">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="#" onclick="goPage(1)" aria-label="Previous">首页</a>
                            </li>
                            <li><a href="#" onclick="goPage(${page.pre})" >上一页</a></li>
                            <c:forEach begin="${page.beg}" end="${page.end}" var="index">
                                <li><a onclick="goPage(${index})" href="#">${index}</a></li>
                            </c:forEach>
                            <li><a href="#" onclick="goPage(${page.next})" >下一页</a></li>
                            <li>
                                <a href="#" onclick="goPage(${page.totalPage})" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
