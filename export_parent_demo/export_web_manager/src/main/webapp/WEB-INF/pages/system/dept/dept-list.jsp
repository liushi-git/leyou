                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <c:forEach items="${page.list}" var="dept"  varStatus="st">
                        <tr>
                            ...
                            <td><a href="${ctx}/system/dept/toUpdate.do?id=${dept.id }">${dept.deptName }</a></td>
                            <th class="text-center"><button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/system/dept/toUpdate.do?id=${dept.id}"'>编辑</button></th>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
